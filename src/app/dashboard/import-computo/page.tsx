              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {[
                    ...
                    <div key={f.field}>
                      ...
                      <input value={String(commessa[f.field as keyof DatiCommessaEstratti] ?? '')} onChange={e => setC(f.field as keyof DatiCommessaEstratti, e.target.value)} placeholder={f.placeholder}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  {[
                    ...
                    <div key={f.field}>
                      <label style={{ fontSize: 10, color: 'var(--t3)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em', display: 'block', marginBottom: 4 }}>{f.label}</label>
                      <input type={f.type} value={String(commessa[f.field as keyof DatiCommessaEstratti] ?? '')} onChange={e => setC(f.field as keyof DatiCommessaEstratti, f.type === 'number' ? +e.target.value : e.target.value)}
                        style={{ width: '100%', boxSizing: 'border-box', background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 7, padding: '9px 12px', color: 'var(--t1)', fontSize: 13 }} />
                    </div>
                  ))}
                </div>
