                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {[
                    ...
                    <div key={f.field}>
                      ...
                      <input value={(commessa as Record<string,unknown>)[f.field] as string || ''} onChange={e => setC(f.field as keyof DatiCommessaEstratti, e.target.value)} placeholder={f.placeholder}
